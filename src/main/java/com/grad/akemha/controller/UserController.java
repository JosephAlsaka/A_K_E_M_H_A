...
//    }
        ...
        @PostMapping(value = "/doctor_request")
        public ResponseEntity<BaseResponse<?>> addDoctorRequest(
        ) {
            return ResponseEntity.ok()
                    .body(new BaseResponse<>(HttpStatus.OK.value(), "doctor request added successfully", null));
